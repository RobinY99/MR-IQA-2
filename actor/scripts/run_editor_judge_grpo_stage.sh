...
ORIGINAL_SCORE_CACHE_EXPECTED_ROW_COUNT="${ORIGINAL_SCORE_CACHE_EXPECTED_ROW_COUNT:-10073}"
ORIGINAL_SCORE_CACHE_EXPECTED_SAMPLE_COUNT="${ORIGINAL_SCORE_CACHE_EXPECTED_SAMPLE_COUNT:-10073}"
ORIGINAL_SCORE_CACHE_EXPECTED_ACTOR_IDS="${ORIGINAL_SCORE_CACHE_EXPECTED_ACTOR_IDS:-source-e5-judge-step725-original-score}"
ORIGINAL_SCORE_CACHE_PAYLOAD_SCHEMA="${ORIGINAL_SCORE_CACHE_PAYLOAD_SCHEMA:-vf_original_score_cache_e5_judge_e5prompt_portable_v1}"
